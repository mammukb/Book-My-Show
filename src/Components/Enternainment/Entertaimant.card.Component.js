...
const EntertainmaentCard = (props) => {
    return (
        <>
...
const EntertainmaentCardSlider = () => {
      ...
      return (
       ...
       <Slider { ...settings}>
      {
        Entertainmentimage.map((image)  => { return (
            <EntertainmaentCard  src = {image} />)
        } )
      }
...
export default EntertainmaentCardSlider ;